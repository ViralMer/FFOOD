...
class OnBoardingScreen extends GetView<OnBoardingController> {
  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: Scaffold(
        body: SafeArea(
          child: GetX<OnBoardingController>(builder: (controller) {
            return Container(
              ...
              child: Column(
                ...
                children: [
                  Expanded(
                    child: Padding(
                      padding: controller.isComplete.value
                                    ...
                                    Container(
                                      height:
                                          MediaQuery.of(context).size.height *
                                              0.5,
                                      child: CommonImageView(
                                        imagePath: Images.icOnBoardThree,
                                        fit: BoxFit.contain,
                                        width: size.width,
                                      ),
                                    ),
                                ...
                                Row(
                                  ...
                                  children: [
                                    SizedBox(
                                        ...
                                        child: SmallText(
                                          text:
                                              "Pickup or Delivery at your door",
                                          size: 30.sp,
                                          color: blackColor,
                                        )),
                                  ],
